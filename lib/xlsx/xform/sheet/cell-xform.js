  ...
  prepare(model, options) {
    ...
    switch (model.type) {
      ...
      case Enums.ValueType.RichText:
        ...
        // Handle hyperlinks in rich text
        if (model.value && model.value.richText) {
          model.value.richText.forEach((richTextSegment, index) => {
            if (richTextSegment.hyperlink) {
              options.hyperlinks.push({
                address: model.address,
                target: richTextSegment.hyperlink,
                tooltip: richTextSegment.tooltip,
              });
            }
          });
        }
