...
class Column {
  ...
  eachCell(options, iteratee) {
    ...
    this._worksheet.eachRow(options, (row, rowNumber) => {
      rowCounter++;
      if (rowCounter > this._worksheet.constructor.maxRows) {
        if (this._worksheet.constructor.bailOnMaxLimit) {
          throw new Error(`Max row count (${this._worksheet.constructor.maxRows}) exceeded`);
        } else {
          bailed = true;
          return;
        }
